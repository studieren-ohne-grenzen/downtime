			...
			function init() {
				...
				renderer.setClearColor( new THREE.Color(0xffffff)); //scene.fog.color );
			...
			function initBirds() {
				...
				birdUniforms = {
					...
					color1: { value: new THREE.Color( 0x62c4ee ) },
					color2: { value: new THREE.Color( 0x0099d3 ) },
					color3: { value: new THREE.Color( 0x0065a1 ) },
